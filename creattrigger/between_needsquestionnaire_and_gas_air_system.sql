...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set c2s_local_atmosphere_air=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set c2s_local_atmosphere_smoke=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set s2c_local_atmosphere_air=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set s2c_local_atmosphere_smoke=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set s2c_local_atmosphere_gas=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set blower_local_atmosphere=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
...
$BODY$
BEGIN
  update gaspowergeneration_gas_air_system set Induced_local_atmosphere=gaspowergeneration_needsquestionnaire.atmosphere_pressure_a
  from gaspowergeneration_needsquestionnaire where gaspowergeneration_needsquestionnaire.plan_id=gaspowergeneration_gas_air_system.plan_id;
RETURN NULL;
END;
$BODY$
