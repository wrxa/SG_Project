...
class I_steam_exhaust_flow(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['h_temperature'] != '' and val['h_temperature'] is not None and val['hh1_water_temperature'] != '' and val['hh1_water_temperature'] is not None and val['hh1_top_difference'] != '' and val['hh1_top_difference'] is not None and val['hh1_pressure_loss'] != '' and val['hh1_pressure_loss'] is not None and val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['d_work_pressure'] != '' and val['d_work_pressure'] is not None and val['d_pressure_loss'] != '' and val['d_pressure_loss'] is not None and val['lh1_top_difference'] != '' and val['lh1_top_difference'] is not None and val['lh1_pressure_loss'] != '' and val['lh1_pressure_loss'] is not None and val['e_exhaust_point_flow'] != '' and val['e_exhaust_point_flow'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['h_blowdown_rate'] != '' and val['h_blowdown_rate'] is not None and val['e_steam_exhaust_pressure'] != '' and val['e_steam_exhaust_pressure'] is not None and val['e_steam_water_loss'] != '' and val['e_steam_water_loss'] is not None and val['e_throttle_flow'] != '' and val['e_throttle_flow'] is not None and val['i_steam_flow'] != '' and val['i_steam_flow'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None and val['i_high2_flow'] != '' and val['i_high2_flow'] is not None and val['i_low2_flow'] != '' and val['i_low2_flow'] is not None:
...
class I_total_power(FieldCalculation):
    def notify(self, val):
        ...
        if val['i_steam_hh1_power'] != '' and val['i_steam_hh1_power'] is not None and val['i_hh2_deoxidize_power'] != '' and val['i_hh2_deoxidize_power'] is not None and val['i_deoxidize_exhaust_power'] != '' and val['i_deoxidize_exhaust_power'] is not None and val['i_exhaust_lh1_power'] != '' and val['i_exhaust_lh1_power'] is not None and val['i_lh2_steam_power'] != '' and val['i_lh2_steam_power'] is not None:
            i_total_power = ((float(val['i_lh2_steam_power']))+(float(val['i_exhaust_lh1_power']))+(float(val['i_hh2_deoxidize_power']))+(float(val['i_deoxidize_exhaust_power']))+(float(val['i_steam_hh1_power'])))
            if i_total_power != -1:
                if val['flg'] == 'design':
...
# 实现字段hh1_saturated_water_temperature:33饱和水温度,的计算56
...
# 实现字段hh1_saturated_water_enthalpy:特殊处理部分--34饱和水焓,的计算57
...
# 实现字段hh1_work_pressure:特殊处理部分--35工作压力,的计算58
...
# 实现字段hh1_extraction_pressure:37抽汽压力,的计算59
...
# 实现字段hh1_extraction_enthalpy:特殊处理部分--38抽汽焓,的计算60
...
# 实现字段hh1_extraction_amount:39抽汽量,的计算61
...
# 实现字段d_water_enthalpy:特殊处理部分--51给水出口焓,的计算62
...
# 实现字段d_extraction_pressure:54抽汽压力,的计算63
...
# 实现字段d_extraction_enthalpy:特殊处理部分--55抽汽焓,的计算64
...
# 实现字段d_extraction_amount:56抽汽量,的计算65
...
# 实现字段lh1_water_temperature:57给水出水温度,的计算66
...
# 实现字段lh1_water_enthalpy:58给水出口焓,的计算67
...
# 实现字段lh1_saturated_water_temperature:60饱和水温度,的计算68
...
# 实现字段lh1_saturated_water_enthalpy:特殊处理部分--61饱和水焓,的计算69
...
# 实现字段lh1_work_pressure:特殊处理部分--62工作压力,的计算70
...
# 实现字段lh1_extraction_pressure:64抽汽压力,的计算71
...
# 实现字段lh1_extraction_enthalpy:特殊处理部分--65抽汽焓,的计算72
...
# 实现字段lh1_extraction_amount:66抽汽量,的计算73
...
# 实现字段c_water_temperature:特殊处理部分--77给水出水温度,的计算74
...
# 实现字段c_water_enthalpy:特殊处理部分--78给水出口焓,的计算75
...
# 实现字段c_work_pressure:79背压工作压力,的计算76
