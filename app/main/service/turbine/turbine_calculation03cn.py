...
# 实现字段i_low2_pressure:1382号低加压力,的计算36
...
# 实现字段i_low2_temperature:特殊处理部分--140温度,的计算38
...
# 实现字段i_low2_enthalpy:特殊处理部分--141焓,的计算39
...
# 实现字段i_steam_exhaust_pressure:144背压压力,的计算41
...
# 实现字段i_steam_exhaust_entropy:145熵,的计算42
...
# 实现字段i_steam_exhaust_enthalpy:特殊处理部分--146焓,的计算43
...
# 实现字段i_steam_exhaust_enthalpy_actual:147实际焓,的计算44
...
# 实现字段i_steam_exhaust_enthalpy_steam:特殊处理部分--148饱和蒸汽焓,的计算45
...
# 实现字段i_steam_exhaust_enthalpy_water:特殊处理部分--149饱和水焓,的计算46
...
# 实现字段i_steam_exhaust_dry:150干度,的计算47
...
# 实现字段i_steam_exhaust_flow:151流量,的计算48
...
# 实现字段i_total_power:153总功率,的计算49
...
# 实现字段i_calculation_error:154计算误差---抽凝,的计算50
...
# 实现字段h_enthalpy:特殊处理部分--28焓值,的计算52
...
# 实现字段hh1_water_temperature:30给水出水温度,的计算54
...
# 实现字段hh1_water_enthalpy:特殊处理部分--31给水出口焓,的计算55
...
# 实现字段hh1_top_difference:32上端差,的计算56
...
# 实现字段hh1_saturated_water_temperature:33饱和水温度,的计算57
...
# 实现字段hh1_saturated_water_enthalpy:特殊处理部分--34饱和水焓,的计算58
...
# 实现字段hh1_work_pressure:特殊处理部分--35工作压力,的计算59
...
# 实现字段hh1_pressure_loss:36抽汽管压损,的计算60
...
# 实现字段hh1_extraction_pressure:37抽汽压力,的计算61
...
# 实现字段hh1_extraction_enthalpy:特殊处理部分--38抽汽焓,的计算62
...
# 实现字段hh1_extraction_amount:39抽汽量,的计算63
...
# 实现字段d_water_enthalpy:特殊处理部分--51给水出口焓,的计算64
...
# 实现字段d_extraction_pressure:54抽汽压力,的计算65
...
# 实现字段d_extraction_enthalpy:特殊处理部分--55抽汽焓,的计算66
...
# 实现字段d_extraction_amount:56抽汽量,的计算67
...
# 实现字段lh1_water_temperature:57给水出水温度,的计算68
...
# 实现字段lh1_water_enthalpy:58给水出口焓,的计算69
...
# 实现字段lh1_saturated_water_temperature:60饱和水温度,的计算70
...
# 实现字段lh1_saturated_water_enthalpy:特殊处理部分--61饱和水焓,的计算71
...
# 实现字段lh1_work_pressure:特殊处理部分--62工作压力,的计算72
...
# 实现字段lh1_extraction_pressure:64抽汽压力,的计算73
...
# 实现字段lh1_extraction_enthalpy:特殊处理部分--65抽汽焓,的计算74
...
# 实现字段lh1_extraction_amount:66抽汽量,的计算75
...
# 实现字段lh2_water_temperature:67给水出水温度,的计算76
...
# 实现字段lh2_water_enthalpy:68给水出口焓,的计算77
...
# 实现字段lh2_saturated_water_temperature:70饱和水温度,的计算78
...
# 实现字段lh2_saturated_water_enthalpy:特殊处理部分--71饱和水焓,的计算79
...
# 实现字段lh2_work_pressure:特殊处理部分--72工作压力,的计算80
...
# 实现字段lh2_extraction_pressure:74抽汽压力,的计算81
...
# 实现字段lh2_extraction_enthalpy:特殊处理部分--75抽汽焓,的计算82
...
# 实现字段lh2_extraction_amount:76高0低3lh2抽汽量,的计算83
...
# 实现字段c_water_temperature:特殊处理部分--77给水出水温度,的计算84
...
# 实现字段c_water_enthalpy:特殊处理部分--78给水出口焓,的计算85
...
# 实现字段c_work_pressure:79背压工作压力,的计算86
...
# 实现字段lh3_water_temperature:90给水出水温度,的计算87
...
# 实现字段lh3_water_enthalpy:91给水出口焓,的计算88
...
# 实现字段lh3_saturated_water_temperature:93饱和水温度,的计算89
...
# 实现字段lh3_saturated_water_enthalpy:特殊处理部分--94饱和水焓,的计算90
...
# 实现字段lh3_work_pressure:特殊处理部分--95工作压力,的计算91
...
# 实现字段lh3_extraction_pressure:97抽汽压力,的计算92
...
# 实现字段lh3_extraction_enthalpy:特殊处理部分--98抽汽焓,的计算93
...
# 实现字段lh3_extraction_amount:99高0低3hh3抽汽量,的计算94
...
# 实现字段i_low3_pressure:1773号低加压力,的计算95
...
# 实现字段i_low3_temperature:特殊处理部分--179温度,的计算97
...
# 实现字段i_low3_enthalpy:特殊处理部分--180焓,的计算98
