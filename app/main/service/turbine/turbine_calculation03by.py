...
class I_steam_exhaust_enthalpy_actual(FieldCalculation):
    def notify(self, val):
        ...
        if val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['lh3_top_difference'] != '' and val['lh3_top_difference'] is not None and val['lh3_pressure_loss'] != '' and val['lh3_pressure_loss'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['e_backpressure_pressure'] != '' and val['e_backpressure_pressure'] is not None and val['i_turbine_efficiency'] != '' and val['i_turbine_efficiency'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None:
            i_steam_exhaust_enthalpy_actual = (seuif97.ps2h((((seuif97.psat_t(((round((round((round((float(val['d_water_temperature']))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))+(float(val['lh3_top_difference']))))*0.1)/(1-(float(val['lh3_pressure_loss']))))),(((seuif97.pt2s(((float(val['e_steam_pressure']))),((float(val['e_steam_temperature'])))))))))-(180-(seuif97.ps2h(((float(val['e_backpressure_pressure']))),((((seuif97.pt2s(((float(val['e_steam_pressure']))),((float(val['e_steam_temperature'])))))))))))*(float(val['i_turbine_efficiency']))
...
class I_steam_exhaust_dry(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['lh3_top_difference'] != '' and val['lh3_top_difference'] is not None and val['lh3_pressure_loss'] != '' and val['lh3_pressure_loss'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['e_backpressure_pressure'] != '' and val['e_backpressure_pressure'] is not None and val['i_turbine_efficiency'] != '' and val['i_turbine_efficiency'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None:
            i_steam_exhaust_dry = 1-(((seuif97.ps2h((((seuif97.psat_t(((round((round((round((float(val['d_water_temperature']))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))-((float(val['d_water_temperature']))-(seuif97.tsat_p(((float(val['e_backpressure_pressure'])))*10)))/((float(val['s_lh_grade']))+1),0))+(float(val['lh3_top_difference']))))*0.1)/(1-(float(val['lh3_pressure_loss']))))),(((seuif97.pt2s(((float(val['e_steam_pressure']))),((float(val['e_steam_temperature'])))))))))-(180-(seuif97.ps2h(((float(val['e_backpressure_pressure']))),((((seuif97.pt2s(((float(val['e_steam_pressure']))),((float(val['e_steam_temperature'])))))))))))*(float(val['i_turbine_efficiency'])))-(seuif97.HL_P(((float(val['e_backpressure_pressure'])))*10)))/((seuif97.HG_P(((float(val['e_backpressure_pressure'])))*10))-(seuif97.HL_P(((float(val['e_backpressure_pressure'])))*10)))
...
class I_steam_exhaust_flow(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['h_temperature'] != '' and val['h_temperature'] is not None and val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['d_work_pressure'] != '' and val['d_work_pressure'] is not None and val['d_pressure_loss'] != '' and val['d_pressure_loss'] is not None and val['lh1_top_difference'] != '' and val['lh1_top_difference'] is not None and val['lh1_pressure_loss'] != '' and val['lh1_pressure_loss'] is not None and val['lh2_top_difference'] != '' and val['lh2_top_difference'] is not None and val['lh2_pressure_loss'] != '' and val['lh2_pressure_loss'] is not None and val['e_exhaust_point_flow'] != '' and val['e_exhaust_point_flow'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['h_blowdown_rate'] != '' and val['h_blowdown_rate'] is not None and val['e_steam_water_loss'] != '' and val['e_steam_water_loss'] is not None and val['e_throttle_flow'] != '' and val['e_throttle_flow'] is not None and val['e_backpressure_pressure'] != '' and val['e_backpressure_pressure'] is not None and val['i_steam_flow'] != '' and val['i_steam_flow'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['i_high1_flow'] != '' and val['i_high1_flow'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None and val['i_high2_flow'] != '' and val['i_high2_flow'] is not None:
