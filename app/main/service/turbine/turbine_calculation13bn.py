...
# 实现字段i_deoxidize_pressure:120D除氧压力,的计算27
...
# 实现字段i_deoxidize_entropy:121熵,的计算28
...
# 实现字段i_deoxidize_temperature:特殊处理部分--122温度,的计算29
...
# 实现字段i_deoxidize_enthalpy:特殊处理部分--123焓,的计算30
...
# 实现字段i_deoxidize_flow:124流量,的计算31
class I_deoxidize_flow(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['h_temperature'] != '' and val['h_temperature'] is not None and val['hh1_water_temperature'] != '' and val['hh1_water_temperature'] is not None and val['hh1_top_difference'] != '' and val['hh1_top_difference'] is not None and val['hh1_pressure_loss'] != '' and val['hh1_pressure_loss'] is not None and val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['d_work_pressure'] != '' and val['d_work_pressure'] is not None and val['d_pressure_loss'] != '' and val['d_pressure_loss'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['h_blowdown_rate'] != '' and val['h_blowdown_rate'] is not None and val['e_steam_exhaust_pressure'] != '' and val['e_steam_exhaust_pressure'] is not None and val['e_steam_water_loss'] != '' and val['e_steam_water_loss'] is not None and val['e_throttle_flow'] != '' and val['e_throttle_flow'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None:
            i_deoxidize_flow = (((float(val['e_throttle_flow']))*((float(val['e_steam_water_loss'])))*((seuif97.HL_T((float(val['d_water_temperature']))))-(seuif97.pt2hz((2*(float(val['d_work_pressure']))),(float(val['h_temperature'])))))+((float(val['e_throttle_flow']))-(((float(val['e_throttle_flow'])))*((seuif97.HL_T((float(val['hh1_water_temperature']))))-(seuif97.HL_T((float(val['d_water_temperature'])))))/((seuif97.ps2h(((seuif97.psat_t(((float(val['hh1_water_temperature']))+(float(val['hh1_top_difference']))))*0.1)/(1-(float(val['hh1_pressure_loss'])))),(seuif97.pt2s((float(val['e_steam_pressure'])),(float(val['e_steam_temperature']))))))-(seuif97.HL_T(((float(val['hh1_water_temperature']))+(float(val['hh1_top_difference']))))))/0.98)-(float(val['e_throttle_flow']))*((float(val['e_steam_water_loss']))))*((seuif97.HL_T((float(val['d_water_temperature']))))-((seuif97.HL_T((float(val['d_water_temperature']))))-((seuif97.HL_T((float(val['d_water_temperature']))))-(seuif97.pt2hw(((float(val['e_steam_exhaust_pressure']))),(seuif97.tsat_p(((float(val['e_steam_exhaust_pressure'])))*10)))))/((float(val['s_lh_grade']))+1)))-((((float(val['e_throttle_flow'])))*((seuif97.HL_T((float(val['hh1_water_temperature']))))-(seuif97.HL_T((float(val['d_water_temperature'])))))/((seuif97.ps2h(((seuif97.psat_t(((float(val['hh1_water_temperature']))+(float(val['hh1_top_difference']))))*0.1)/(1-(float(val['hh1_pressure_loss'])))),(seuif97.pt2s((float(val['e_steam_pressure'])),(float(val['e_steam_temperature']))))))-(seuif97.HL_T(((float(val['hh1_water_temperature']))+(float(val['hh1_top_difference']))))))/0.98))*((seuif97.HL_T((float(val['d_water_temperature'])))))*0.98)/(((seuif97.ps2h(((float(val['d_work_pressure']))/(1-(float(val['d_pressure_loss'])))),(seuif97.pt2s((float(val['e_steam_pressure'])),(float(val['e_steam_temperature']))))))-(seuif97.HL_T((float(val['d_water_temperature'])))))*0.98+((seuif97.HL_T((float(val['d_water_temperature']))))-((seuif97.HL_T((float(val['d_water_temperature']))))-((seuif97.HL_T((float(val['d_water_temperature']))))-(seuif97.pt2hw(((float(val['e_steam_exhaust_pressure']))),(seuif97.tsat_p(((float(val['e_steam_exhaust_pressure'])))*10)))))/((float(val['s_lh_grade']))+1)))))
...
# 实现字段i_exhaust_point_pressure:126抽汽点压力,的计算32
...
# 实现字段i_exhaust_point_temperature:127温度,的计算33
...
# 实现字段i_exhaust_point_entropy:128熵,的计算34
...
# 实现字段i_exhaust_point_enthalpy:129焓,的计算35
...
# 实现字段i_exhaust_point_flow:130流量,的计算36
...
# 实现字段i_low1_pressure:1321号低加压力,的计算37
...
# 实现字段i_low1_temperature:特殊处理部分--134温度,的计算39
...
# 实现字段i_low1_enthalpy:特殊处理部分--135焓,的计算40
...
# 实现字段i_low1_flow:136流量,的计算41
class I_low1_flow(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['h_temperature'] != '' and val['h_temperature'] is not None and val['hh1_water_temperature'] != '' and val['hh1_water_temperature'] is not None and val['hh1_top_difference'] != '' and val['hh1_top_difference'] is not None and val['hh1_pressure_loss'] != '' and val['hh1_pressure_loss'] is not None and val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['d_work_pressure'] != '' and val['d_work_pressure'] is not None and val['d_pressure_loss'] != '' and val['d_pressure_loss'] is not None and val['lh1_top_difference'] != '' and val['lh1_top_difference'] is not None and val['lh1_pressure_loss'] != '' and val['lh1_pressure_loss'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['h_blowdown_rate'] != '' and val['h_blowdown_rate'] is not None and val['e_steam_exhaust_pressure'] != '' and val['e_steam_exhaust_pressure'] is not None and val['e_steam_water_loss'] != '' and val['e_steam_water_loss'] is not None and val['e_throttle_flow'] != '' and val['e_throttle_flow'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None:
...
# 实现字段i_low2_pressure:1382号低加压力,的计算42
...
# 实现字段i_low2_temperature:特殊处理部分--140温度,的计算44
...
# 实现字段i_low2_enthalpy:特殊处理部分--141焓,的计算45
...
class I_steam_exhaust_flow(FieldCalculation):
    def notify(self, val):
        result = val['dbresult']
        if val['h_temperature'] != '' and val['h_temperature'] is not None and val['hh1_water_temperature'] != '' and val['hh1_water_temperature'] is not None and val['hh1_top_difference'] != '' and val['hh1_top_difference'] is not None and val['hh1_pressure_loss'] != '' and val['hh1_pressure_loss'] is not None and val['d_water_temperature'] != '' and val['d_water_temperature'] is not None and val['d_work_pressure'] != '' and val['d_work_pressure'] is not None and val['d_pressure_loss'] != '' and val['d_pressure_loss'] is not None and val['lh1_top_difference'] != '' and val['lh1_top_difference'] is not None and val['lh1_pressure_loss'] != '' and val['lh1_pressure_loss'] is not None and val['lh2_top_difference'] != '' and val['lh2_top_difference'] is not None and val['lh2_pressure_loss'] != '' and val['lh2_pressure_loss'] is not None and val['e_exhaust_point_flow'] != '' and val['e_exhaust_point_flow'] is not None and val['s_lh_grade'] != '' and val['s_lh_grade'] is not None and val['h_blowdown_rate'] != '' and val['h_blowdown_rate'] is not None and val['e_steam_exhaust_pressure'] != '' and val['e_steam_exhaust_pressure'] is not None and val['e_steam_water_loss'] != '' and val['e_steam_water_loss'] is not None and val['e_throttle_flow'] != '' and val['e_throttle_flow'] is not None and val['i_steam_flow'] != '' and val['i_steam_flow'] is not None and val['e_steam_pressure'] != '' and val['e_steam_pressure'] is not None and val['e_steam_temperature'] != '' and val['e_steam_temperature'] is not None and val['i_high2_flow'] != '' and val['i_high2_flow'] is not None:
...
# 实现字段d_water_enthalpy:特殊处理部分--51给水出口焓,的计算67
...
# 实现字段d_extraction_pressure:54抽汽压力,的计算68
...
# 实现字段d_extraction_enthalpy:特殊处理部分--55抽汽焓,的计算69
...
# 实现字段d_extraction_amount:56抽汽量,的计算70
...
# 实现字段lh1_water_temperature:57给水出水温度,的计算71
...
# 实现字段lh1_water_enthalpy:58给水出口焓,的计算72
...
# 实现字段lh1_saturated_water_temperature:60饱和水温度,的计算73
...
# 实现字段lh1_saturated_water_enthalpy:特殊处理部分--61饱和水焓,的计算74
...
# 实现字段lh1_work_pressure:特殊处理部分--62工作压力,的计算75
...
# 实现字段lh1_extraction_pressure:64抽汽压力,的计算76
...
# 实现字段lh1_extraction_enthalpy:特殊处理部分--65抽汽焓,的计算77
...
# 实现字段lh1_extraction_amount:66抽汽量,的计算78
...
# 实现字段lh2_water_temperature:67给水出水温度,的计算79
...
# 实现字段lh2_water_enthalpy:68给水出口焓,的计算80
...
# 实现字段lh2_saturated_water_temperature:70饱和水温度,的计算81
...
# 实现字段lh2_saturated_water_enthalpy:特殊处理部分--71饱和水焓,的计算82
...
# 实现字段lh2_work_pressure:特殊处理部分--72工作压力,的计算83
...
# 实现字段lh2_extraction_pressure:74抽汽压力,的计算84
...
# 实现字段lh2_extraction_enthalpy:特殊处理部分--75抽汽焓,的计算85
...
# 实现字段lh2_extraction_amount:76高1低3lh2抽汽量,的计算86
...
# 实现字段lh3_water_temperature:90给水出水温度,的计算90
...
# 实现字段lh3_water_enthalpy:91给水出口焓,的计算91
...
# 实现字段lh3_saturated_water_temperature:93饱和水温度,的计算92
...
# 实现字段lh3_saturated_water_enthalpy:特殊处理部分--94饱和水焓,的计算93
...
# 实现字段lh3_work_pressure:特殊处理部分--95工作压力,的计算94
...
# 实现字段lh3_extraction_pressure:97抽汽压力,的计算95
...
# 实现字段lh3_extraction_enthalpy:特殊处理部分--98抽汽焓,的计算96
...
# 实现字段lh3_extraction_amount:99高1低3hh3抽汽量,的计算97
...
# 实现字段i_low3_pressure:1773号低加压力,的计算98
...
# 实现字段i_low3_temperature:特殊处理部分--179温度,的计算100
...
# 实现字段i_low3_enthalpy:特殊处理部分--180焓,的计算101
