...
# 实现字段hh1_water_enthalpy:特殊处理部分--31给水出口焓,的计算54
...
# 实现字段hh1_saturated_water_temperature:33饱和水温度,的计算55
...
# 实现字段hh1_saturated_water_enthalpy:特殊处理部分--34饱和水焓,的计算56
...
# 实现字段hh1_work_pressure:特殊处理部分--35工作压力,的计算57
...
# 实现字段hh1_extraction_pressure:37抽汽压力,的计算58
...
# 实现字段hh1_extraction_enthalpy:特殊处理部分--38抽汽焓,的计算59
...
# 实现字段hh1_extraction_amount:39抽汽量,的计算60
...
# 实现字段d_water_enthalpy:特殊处理部分--51给水出口焓,的计算61
...
# 实现字段d_extraction_pressure:54抽汽压力,的计算62
...
# 实现字段d_extraction_enthalpy:特殊处理部分--55抽汽焓,的计算63
...
# 实现字段d_extraction_amount:56抽汽量,的计算64
...
# 实现字段lh1_water_temperature:57给水出水温度,的计算65
...
# 实现字段lh1_water_enthalpy:58给水出口焓,的计算66
...
# 实现字段lh1_saturated_water_temperature:60饱和水温度,的计算67
...
# 实现字段lh1_saturated_water_enthalpy:特殊处理部分--61饱和水焓,的计算68
...
# 实现字段lh1_work_pressure:特殊处理部分--62工作压力,的计算69
...
# 实现字段lh1_extraction_pressure:64抽汽压力,的计算70
...
# 实现字段lh1_extraction_enthalpy:特殊处理部分--65抽汽焓,的计算71
...
# 实现字段lh1_extraction_amount:66抽汽量,的计算72
...
# 实现字段c_water_temperature:特殊处理部分--77给水出水温度,的计算73
...
# 实现字段c_water_enthalpy:特殊处理部分--78给水出口焓,的计算74
...
# 实现字段c_work_pressure:79背压工作压力,的计算75
