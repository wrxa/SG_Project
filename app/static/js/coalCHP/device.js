    ...
    var tbodyString = "<tr attrid='" + type + "' class='alert alert-success alert-dismissible' role='alert'>"
        ...
        for(var j = 0; j < equipmentCount; j++){
            if(data.equipment_type[j] == type){
                ...
                + "<textarea style='resize:none;height: 40px;' onkeydown='checkEnter(event)' wrap='soft' class='form-control name' name='equipmentName_" + j + "' id='equipmentName_" + j + "'>" + data.equipment_name[j] + "</textarea>"
                ...
                + "<textarea style='resize:none;height: 40px;' onkeydown='checkEnter(event)' wrap='soft' class='form-control content' name='equipmentContent_" + j + "' id='equipmentContent_" + j + "'>" + data.equipment_content[j] + "</textarea>"
                ...
                + "<textarea style='resize:none;height: 40px;' onkeydown='checkEnter(event)' wrap='soft' class='form-control count' name='equipmentCount_" + j + "' id='equipmentCount_" + j + "'>" + data.equipment_count[j] + "</textarea>"
                ...
                + "<textarea style='resize:none;height: 40px;' onkeydown='checkEnter(event)' wrap='soft' class='form-control remark' name='equipmentRemark_" + j + "' id='equipmentRemark_" + j + "'>" + data.equipment_remark[j] + "</textarea>"
                +"</td>";
    ...
    $.ajax({
        ...
        success: function (data) {
            if(data.state == 'success'){
                ...
                if(flag == 0){
                    messageToast('success', '燃煤热电联产-设备清单删除失败',2000);
                }else{
                    messageToast('error', '燃煤热电联产-设备清单保存失败',2000);
                }
            }
