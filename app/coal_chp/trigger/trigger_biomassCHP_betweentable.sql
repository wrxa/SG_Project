...
CREATE OR REPLACE FUNCTION biomasschp_boiler_calculation_c_hydrogen_content_received_desi()
RETURNS TRIGGER AS
$BODY$
BEGIN
...
FOR EACH ROW
EXECUTE PROCEDURE "biomasschp_boiler_calculation_c_hydrogen_content_received_desi"();
