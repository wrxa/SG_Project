...
----------------------------------------------------------------
  ...
  IF OLD.p_temperature_case_f != NEW.p_temperature_case_f THEN
     update coalchp_smoke_air_system set 

     f_air_temperature=NEW.p_temperature_case_f
     where plan_id=NEW.plan_id;

  ELSIF (OLD.p_temperature_case_f ISNULL) AND NEW.p_temperature_case_f NOTNULL THEN
     update coalchp_smoke_air_system set 
  ...
  END IF;
   ...
   IF OLD.p_temperature_case_s != NEW.p_temperature_case_s THEN
     update coalchp_smoke_air_system set 

     s_air_temperature=NEW.p_temperature_case_s
     where plan_id=NEW.plan_id;

  ELSIF (OLD.p_temperature_case_s ISNULL) AND NEW.p_temperature_case_s NOTNULL THEN
     update coalchp_smoke_air_system set 
  ...
  IF OLD.p_temperature_case_t != NEW.p_temperature_case_t THEN
     update coalchp_smoke_air_system set 

     i_air_temperature=NEW.p_temperature_case_t
     where plan_id=NEW.plan_id;

  ELSIF (OLD.p_temperature_case_t ISNULL) AND NEW.p_temperature_case_t NOTNULL THEN
     update coalchp_smoke_air_system set 
