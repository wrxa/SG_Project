...
-- 生物质热电联产
    ELSEIF TG_OP='INSERT' AND MODULEID='biomassCHP' THEN
       ...
       INSERT INTO biomasschp_boiler_auxiliaries (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_water_treatment (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_official_process (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_turbine_backpressure (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_heat_supply (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_chimney (plan_id) VALUES (NEWIDD);
       INSERT INTO biomasschp_circulating_water (plan_id) VALUES (NEWIDD);
