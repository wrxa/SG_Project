...
-- 煤气发电
		ELSEIF TG_OP='INSERT' AND MODULEID='gasPowerGeneration' THEN
			...
			INSERT INTO gaspowergeneration_turbine_auxiliary_system (plan_id) VALUES (NEWIDD);
			INSERT INTO gaspowergeneration_steam_water_pipe (plan_id) VALUES (NEWIDD);
			INSERT INTO gaspowergeneration_boiler_auxiliaries (plan_id) VALUES (NEWIDD);
			INSERT INTO gaspowergeneration_turbine_of_pts (plan_id) VALUES (NEWIDD);
			RETURN NULL;
		ELSE
			RETURN NULL;
		END IF;
