...
--用于同步表：coalchp_needs_questionnaire的s_grindability_design字段，和表coalchp_furnace_calculation的s_grindability_design字段，即：coalchp_furnace_calculation.s_grindability_design=coalchp_needs_questionnaire.s_grindability_design
CREATE OR REPLACE FUNCTION coalchp_furnace_calculation_s_grindability_design()
RETURNS TRIGGER AS
$BODY$
BEGIN
  update coalchp_furnace_calculation set s_grindability_design=coalchp_needs_questionnaire.s_grindability_design
  from coalchp_needs_questionnaire where coalchp_needs_questionnaire.plan_id=coalchp_furnace_calculation.plan_id;
RETURN NULL;
END;
$BODY$
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_1" AFTER UPDATE OF "s_carbon_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_2" AFTER UPDATE OF "s_hydrogen_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_3" AFTER UPDATE OF "s_hydrogen_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_4" AFTER UPDATE OF "s_oxygen_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_5" AFTER UPDATE OF "s_oxygen_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_6" AFTER UPDATE OF "s_nitrogen_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_7" AFTER UPDATE OF "s_nitrogen_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_8" AFTER UPDATE OF "s_sulfur_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_9" AFTER UPDATE OF "s_sulfur_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_10" AFTER UPDATE OF "s_water_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_11" AFTER UPDATE OF "s_water_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_12" AFTER UPDATE OF "s_grey_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_13" AFTER UPDATE OF "s_grey_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_14" AFTER UPDATE OF "s_daf_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_15" AFTER UPDATE OF "s_daf_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
EXECUTE PROCEDURE "coalchp_furnace_calculation_s_daf_check"();


--该触发器用于：当s_grindability_design有更新时触发coalchp_furnace_calculation.s_grindability_design=coalchp_needs_questionnaire.s_grindability_design
CREATE TRIGGER "coalchp_needs_questionnaire_a_16" AFTER UPDATE OF "s_grindability_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_17" AFTER UPDATE OF "s_grindability_check" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_18" AFTER UPDATE OF "s_low_design" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_21" AFTER UPDATE OF "w_annual_average_relative_humidity_value" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_22" AFTER UPDATE OF "w_mean_annual_barometric_value" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_23" AFTER UPDATE OF "w_mean_annual_barometric_value" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_24" AFTER UPDATE OF "w_mean_annual_temperature_value" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
...
CREATE TRIGGER "coalchp_needs_questionnaire_a_25" AFTER UPDATE OF "w_mean_annual_temperature_value" ON "public"."coalchp_needs_questionnaire"
FOR EACH ROW
