...
----------------------实现字段air_preheater_local_resistance:局部阻力,的计算12-----------------------------------
  IF OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_reducer_tube != NEW.air_preheater_reducer_tube OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     update gaspowergeneration_smoke_resistance set 

     air_preheater_local_resistance=(((NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient*NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient))+((NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient*(1+NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient)))+NEW.air_preheater_reducer_tube)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)
     where plan_id=NEW.plan_id;

  ELSIF (OLD.air_preheater_reducer_tube ISNULL OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_flow_velocity ISNULL OR OLD.air_preheater_density ISNULL) AND NEW.air_preheater_reducer_tube NOTNULL AND NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_flow_velocity NOTNULL AND NEW.air_preheater_density NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段air_preheater_local_resistance_coefficient:局部阻力系数,的计算13-----------------------------------
  IF OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_reducer_tube != NEW.air_preheater_reducer_tube THEN
     ...
     air_preheater_local_resistance_coefficient=((NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient*NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient))+((NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient*(1+NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient)))+NEW.air_preheater_reducer_tube
     where plan_id=NEW.plan_id;

  ELSIF (OLD.air_preheater_reducer_tube ISNULL OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient ISNULL) AND NEW.air_preheater_reducer_tube NOTNULL AND NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段air_preheater_90_outlet_sharp_turn_elbow:1个90度空预器出口变径急转弯头,的计算14-----------------------------------
  IF OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     air_preheater_90_outlet_sharp_turn_elbow=(NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient*NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient)
     where plan_id=NEW.plan_id;

  ELSIF (OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient ISNULL) AND NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
  ...
  END IF;
----------------------实现字段air_preheater_sharp_turn_elbow_powder_local_resistance_coefficient:含粉气体局部阻力系数,的计算15-----------------------------------
  IF OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     air_preheater_sharp_turn_elbow_powder_local_resistance_coefficient=NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient*NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient
     where plan_id=NEW.plan_id;
...
----------------------实现字段air_preheater_90_section_slow_turn_elbow:1个90度等截面缓转弯头,的计算16-----------------------------------
  IF OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     air_preheater_90_section_slow_turn_elbow=(NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient*(1+NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient))
     where plan_id=NEW.plan_id;

  ELSIF (OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL) AND NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
  ...
  END IF;
----------------------实现字段air_preheater_slow_turn_elbow_powder_local_resistance_coefficient:含粉气体局部阻力系数,的计算17-----------------------------------
  IF OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     air_preheater_slow_turn_elbow_powder_local_resistance_coefficient=NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient*(1+NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient)
     where plan_id=NEW.plan_id;
...
----------------------实现字段air_preheater_to_deduster_total_resistance:空预器出口至除尘器入口总阻力,的计算18-----------------------------------
  IF OLD.air_preheater_length != NEW.air_preheater_length OR OLD.air_preheater_frictional_resistance_coefficient != NEW.air_preheater_frictional_resistance_coefficient OR OLD.air_preheater_ducting_length != NEW.air_preheater_ducting_length OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_reducer_tube != NEW.air_preheater_reducer_tube OR OLD.air_preheater_outlet_smoke_amount != NEW.air_preheater_outlet_smoke_amount OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     update gaspowergeneration_smoke_resistance set 
  ...
  ELSIF (OLD.air_preheater_reducer_tube ISNULL OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_ducting_length ISNULL OR OLD.air_preheater_frictional_resistance_coefficient ISNULL OR OLD.air_preheater_length ISNULL OR OLD.air_preheater_flow_velocity ISNULL OR OLD.air_preheater_density ISNULL OR OLD.air_preheater_outlet_smoke_amount ISNULL) AND NEW.air_preheater_reducer_tube NOTNULL AND NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_ducting_length NOTNULL AND NEW.air_preheater_frictional_resistance_coefficient NOTNULL AND NEW.air_preheater_length NOTNULL AND NEW.air_preheater_flow_velocity NOTNULL AND NEW.air_preheater_density NOTNULL AND NEW.air_preheater_outlet_smoke_amount NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段deduster_local_resistance:局部阻力,的计算30-----------------------------------
  IF OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_inlet_bellows != NEW.deduster_inlet_bellows OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_local_resistance=(((NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient))+(((NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient))+NEW.deduster_inlet_bellows)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_inlet_bellows ISNULL OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_section_original_resistance_coefficient_with_roughness ISNULL OR OLD.deduster_section_corrected_height_width_ratio_coefficient ISNULL OR OLD.deduster_corrected_turning_angle_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_flow_velocity ISNULL OR OLD.air_preheater_density ISNULL) AND NEW.deduster_inlet_bellows NOTNULL AND NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_section_original_resistance_coefficient_with_roughness NOTNULL AND NEW.deduster_section_corrected_height_width_ratio_coefficient NOTNULL AND NEW.deduster_corrected_turning_angle_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_flow_velocity NOTNULL AND NEW.air_preheater_density NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段deduster_local_resistance_coefficient:局部阻力系数,的计算31-----------------------------------
  IF OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_inlet_bellows != NEW.deduster_inlet_bellows THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_local_resistance_coefficient=((NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient))+(((NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient))+NEW.deduster_inlet_bellows
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_inlet_bellows ISNULL OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_section_original_resistance_coefficient_with_roughness ISNULL OR OLD.deduster_section_corrected_height_width_ratio_coefficient ISNULL OR OLD.deduster_corrected_turning_angle_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL) AND NEW.deduster_inlet_bellows NOTNULL AND NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_section_original_resistance_coefficient_with_roughness NOTNULL AND NEW.deduster_section_corrected_height_width_ratio_coefficient NOTNULL AND NEW.deduster_corrected_turning_angle_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段deduster_90_outlet_slow_turn_elbow:1个90度除尘器出口缓转弯头,的计算32-----------------------------------
  IF OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_90_outlet_slow_turn_elbow=(NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient)
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL) AND NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
  ...
  END IF;
----------------------实现字段deduster_slow_turn_elbow_powder_local_resistance_coefficient:含粉气体局部阻力系数,的计算33-----------------------------------
  IF OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_slow_turn_elbow_powder_local_resistance_coefficient=NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient
     where plan_id=NEW.plan_id;
...
----------------------实现字段deduster_90_section_slow_turn_elbow:1个90度等截面缓转弯头,的计算34-----------------------------------
  IF OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_90_section_slow_turn_elbow=((NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient)
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_section_original_resistance_coefficient_with_roughness ISNULL OR OLD.deduster_section_corrected_height_width_ratio_coefficient ISNULL OR OLD.deduster_corrected_turning_angle_coefficient ISNULL) AND NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_section_original_resistance_coefficient_with_roughness NOTNULL AND NEW.deduster_section_corrected_height_width_ratio_coefficient NOTNULL AND NEW.deduster_corrected_turning_angle_coefficient NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
  ...
  END IF;
----------------------实现字段deduster_section_slow_turn_elbow_powder_local_resistance_coefficient:含粉气体局部阻力系数,的计算35-----------------------------------
  IF OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_section_slow_turn_elbow_powder_local_resistance_coefficient=(NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient
     where plan_id=NEW.plan_id;
  ...
  END IF;
----------------------实现字段deduster_section_slow_turn_elbow_air_elbow_local_resistance_coefficient:纯空气局部阻力系数,的计算36-----------------------------------
  IF OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_section_slow_turn_elbow_air_elbow_local_resistance_coefficient=NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness
     where plan_id=NEW.plan_id;
...
----------------------实现字段deduster_to_induced_draft_total_resistance:除尘器出口至引风机入口总阻力,的计算37-----------------------------------
  IF OLD.deduster_flow_velocity != NEW.deduster_flow_velocity OR OLD.deduster_length != NEW.deduster_length OR OLD.deduster_frictional_resistance_coefficient != NEW.deduster_frictional_resistance_coefficient OR OLD.deduster_ducting_length != NEW.deduster_ducting_length OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_inlet_bellows != NEW.deduster_inlet_bellows OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     update gaspowergeneration_smoke_resistance set 

     deduster_to_induced_draft_total_resistance=((((NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient))+(((NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient))+NEW.deduster_inlet_bellows)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2))+(NEW.deduster_ducting_length*(NEW.deduster_frictional_resistance_coefficient*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/(4*(((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/NEW.deduster_flow_velocity/3600)/(2*(NEW.deduster_length+((((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/NEW.deduster_flow_velocity/3600)/NEW.deduster_length))))))
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_inlet_bellows ISNULL OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_section_original_resistance_coefficient_with_roughness ISNULL OR OLD.deduster_section_corrected_height_width_ratio_coefficient ISNULL OR OLD.deduster_corrected_turning_angle_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.deduster_ducting_length ISNULL OR OLD.deduster_frictional_resistance_coefficient ISNULL OR OLD.deduster_length ISNULL OR OLD.deduster_flow_velocity ISNULL OR OLD.air_preheater_flow_velocity ISNULL OR OLD.air_preheater_density ISNULL) AND NEW.deduster_inlet_bellows NOTNULL AND NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_section_original_resistance_coefficient_with_roughness NOTNULL AND NEW.deduster_section_corrected_height_width_ratio_coefficient NOTNULL AND NEW.deduster_corrected_turning_angle_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.deduster_ducting_length NOTNULL AND NEW.deduster_frictional_resistance_coefficient NOTNULL AND NEW.deduster_length NOTNULL AND NEW.deduster_flow_velocity NOTNULL AND NEW.air_preheater_flow_velocity NOTNULL AND NEW.air_preheater_density NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
----------------------实现字段induced_draft_to_chimney_total_resistance:引风机出口至烟囱入口总阻力,的计算54-----------------------------------
  IF OLD.induced_draft_corrected_turning_angle_coefficient != NEW.induced_draft_corrected_turning_angle_coefficient OR OLD.induced_draft_corrected_height_width_ratio_coefficient != NEW.induced_draft_corrected_height_width_ratio_coefficient OR OLD.induced_draft_original_resistance_coefficient_with_roughness != NEW.induced_draft_original_resistance_coefficient_with_roughness OR OLD.induced_draft_powder_concentration_corrected_coefficient != NEW.induced_draft_powder_concentration_corrected_coefficient OR OLD.brick_chimney_inlet != NEW.brick_chimney_inlet OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     ...
     induced_draft_to_chimney_total_resistance=((((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)6+((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)7+(((NEW.induced_draft_corrected_turning_angle_coefficient*NEW.induced_draft_corrected_height_width_ratio_coefficient*NEW.induced_draft_original_resistance_coefficient_with_roughness)*NEW.induced_draft_powder_concentration_corrected_coefficient))+NEW.brick_chimney_inlet)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2))+((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)0
     where plan_id=NEW.plan_id;
...
----------------------实现字段smoke_chimney_total_resistance:烟道总阻力,的计算55-----------------------------------
  IF OLD.air_preheater_length != NEW.air_preheater_length OR OLD.air_preheater_frictional_resistance_coefficient != NEW.air_preheater_frictional_resistance_coefficient OR OLD.air_preheater_ducting_length != NEW.air_preheater_ducting_length OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.air_preheater_reducer_tube != NEW.air_preheater_reducer_tube OR OLD.deduster_flow_velocity != NEW.deduster_flow_velocity OR OLD.deduster_length != NEW.deduster_length OR OLD.deduster_frictional_resistance_coefficient != NEW.deduster_frictional_resistance_coefficient OR OLD.deduster_ducting_length != NEW.deduster_ducting_length OR OLD.air_preheater_outlet_smoke_amount != NEW.air_preheater_outlet_smoke_amount OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient != NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_corrected_turning_angle_coefficient != NEW.deduster_corrected_turning_angle_coefficient OR OLD.deduster_section_corrected_height_width_ratio_coefficient != NEW.deduster_section_corrected_height_width_ratio_coefficient OR OLD.deduster_section_original_resistance_coefficient_with_roughness != NEW.deduster_section_original_resistance_coefficient_with_roughness OR OLD.air_preheater_density != NEW.air_preheater_density OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient != NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient OR OLD.deduster_inlet_bellows != NEW.deduster_inlet_bellows OR OLD.air_preheater_flow_velocity != NEW.air_preheater_flow_velocity THEN
     update gaspowergeneration_smoke_resistance set 

     smoke_chimney_total_resistance=(((((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)6+((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)7+((((NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)1*(NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)2*(NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)3)*(NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)4))+(NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)5)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2))+((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)0)+(((((NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient*NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient))+(((NEW.deduster_corrected_turning_angle_coefficient*NEW.deduster_section_corrected_height_width_ratio_coefficient*NEW.deduster_section_original_resistance_coefficient_with_roughness)*NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient))+NEW.deduster_inlet_bellows)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2))+(NEW.deduster_ducting_length*(NEW.deduster_frictional_resistance_coefficient*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/(4*(((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/NEW.deduster_flow_velocity/3600)/(2*(NEW.deduster_length+((((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/NEW.deduster_flow_velocity/3600)/NEW.deduster_length)))))))+(((((NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient*NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient))+((NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient*(1+NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient)))+NEW.air_preheater_reducer_tube)*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2))+(NEW.air_preheater_ducting_length*(NEW.air_preheater_frictional_resistance_coefficient*((NEW.air_preheater_density)*(NEW.air_preheater_flow_velocity)^2/2)/(4*(NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)/(2*(NEW.air_preheater_length+((NEW.air_preheater_outlet_smoke_amount/NEW.air_preheater_flow_velocity/3600)/NEW.air_preheater_length)))))))
     where plan_id=NEW.plan_id;

  ELSIF (OLD.deduster_inlet_bellows ISNULL OR OLD.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_section_original_resistance_coefficient_with_roughness ISNULL OR OLD.deduster_section_corrected_height_width_ratio_coefficient ISNULL OR OLD.deduster_corrected_turning_angle_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.deduster_ducting_length ISNULL OR OLD.deduster_frictional_resistance_coefficient ISNULL OR OLD.deduster_length ISNULL OR OLD.deduster_flow_velocity ISNULL OR OLD.air_preheater_reducer_tube ISNULL OR OLD.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient ISNULL OR OLD.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient ISNULL OR OLD.air_preheater_ducting_length ISNULL OR OLD.air_preheater_frictional_resistance_coefficient ISNULL OR OLD.air_preheater_length ISNULL OR OLD.air_preheater_flow_velocity ISNULL OR OLD.air_preheater_density ISNULL OR OLD.air_preheater_outlet_smoke_amount ISNULL) AND NEW.deduster_inlet_bellows NOTNULL AND NEW.deduster_section_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_section_original_resistance_coefficient_with_roughness NOTNULL AND NEW.deduster_section_corrected_height_width_ratio_coefficient NOTNULL AND NEW.deduster_corrected_turning_angle_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.deduster_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.deduster_ducting_length NOTNULL AND NEW.deduster_frictional_resistance_coefficient NOTNULL AND NEW.deduster_length NOTNULL AND NEW.deduster_flow_velocity NOTNULL AND NEW.air_preheater_reducer_tube NOTNULL AND NEW.air_preheater_slow_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_slow_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_powder_concentration_corrected_coefficient NOTNULL AND NEW.air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient NOTNULL AND NEW.air_preheater_ducting_length NOTNULL AND NEW.air_preheater_frictional_resistance_coefficient NOTNULL AND NEW.air_preheater_length NOTNULL AND NEW.air_preheater_flow_velocity NOTNULL AND NEW.air_preheater_density NOTNULL AND NEW.air_preheater_outlet_smoke_amount NOTNULL THEN
     update gaspowergeneration_smoke_resistance set 
...
"air_preheater_sharp_turn_elbow_air_elbow_local_resistance_coefficient",
